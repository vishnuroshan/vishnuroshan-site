...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-22 (commit 071ef41). Confidence: 100%.
...
- `app.js` — 5 commits/90d

### Code health
Three co-equal signals: defect risk 9.96/10 avg, hotspot health 10.0/10 (stable), worst `scripts/build-llms-txt.py` at 9.07/10 · maintainability 10.0/10 · performance risk 0 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
