...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-22 (commit cfac545). Confidence: 100%.
...
### Code health
Three co-equal signals: defect risk 9.95/10 avg, hotspot health 10.0/10 (stable), worst `scripts/build-llms-txt.py` at 9.07/10 · maintainability 10.0/10 · performance risk 0 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
